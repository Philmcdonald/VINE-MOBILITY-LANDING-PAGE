...
const Testimonial = () => {
  ...
  return (
    <Section classes="border-y border-y-primary-main py-10" id="testimonial">
      <div className="bg-black rounded-xl grid grid-cols-1 gap-5 md:gap-0 md:grid-cols-[45%_50%] lg:grid-cols-[45%_50%] justify-between items-center py-14 px-6 md:px-10 lg:px-12">
        {/* Left Section */}
        <div className="">
