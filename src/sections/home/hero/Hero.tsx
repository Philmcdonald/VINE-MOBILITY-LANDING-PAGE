      ...
      <div className="grid grid-cols-1 md:grid-cols-[50%_50%] lg:grid-cols-[50%_50%] gap-10 md:gap-0 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="font-medium mb-5">
            Join the future of electric mobility with Vine MObility&apos;s smart
            EV charger. Designed for homes, businesses, and public spaces, our
            charger enhances property value and attracts eco-conscious buyers
            and tenants.
            <br />
