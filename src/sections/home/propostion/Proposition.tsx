  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:gap-7 projects__container">
      ...
      <div className="mt-3 md:mt-5 lg:mt-10">
        <h3 className="mx-auto text-center">Exclusive Pre-Launch Offer</h3>
        <div className=" grid grid-cols-1 sm:grid-cols-2 md:gap-10 lg:gap-16 mt-[-10px] lg:mt-[-15px] lg:pt-0 md:pb-3 ">
          <div className="propositionSlide  mt-[-10px] md:mt-0 h-[25rem] md:h-[20rem] lg:h-[30rem]"></div>

          <div className="self-center mt-[-20px] md:mt-5">
            <Heading>
